...
class TTTGame
  ...
  def display_board(clear_screen = true) #will clear by default, but if pass in false, then wont clear
    clear if clear_screen #to get rid of outputs to clear up screen
